...
```ruby
todo_boolean = todo_checker(text)

text: a string which may or may not contain the string #TODO
todo_boolean = boolean to let us know if a string contains the string #TODO (could also return the TODO?)
